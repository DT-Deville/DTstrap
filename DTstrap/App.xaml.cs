...
namespace DTstrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "DTstrap-QA";
#else
        public const string ProjectName = "DTstrap";
#endif
        public const string ProjectOwner = "DTstrap";
        public const string ProjectRepository = "dtstraplabs/dtstrap";
        public const string ProjectDownloadLink = "https://dtstraplabs.com";
        public const string ProjectHelpLink = "https://dtstraplabs.com/wiki/help/";
        public const string ProjectSupportLink = "https://github.com/dtstraplabs/dtstrap/issues/new";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructDTstrapWebUrl();
        ...
        public static string ConstructDTstrapWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "services.dtstraplabs.com";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"services-{sub}.dtstraplabs.com";
        }
        ...
        {
            // Auto-update disabled: no release endpoint configured for this build
        ...
        {
            // Analytics endpoint not configured for this build
            await Task.CompletedTask;
        }
