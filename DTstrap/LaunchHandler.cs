...
using DTstrap.UI.Elements.Dialogs;
using DTstrap.Enums;
...
namespace DTstrap
{
    public static class LaunchHandler
    {
        ...
        public static void LaunchSettings()
        {
            ...
            else
            {
                ...
                if (process is not null)
                    NativeInterop.SetForegroundWindow(process.MainWindowHandle);
        ...
        public static void LaunchBackgroundUpdater()
        {
            ...
            App.Bootstrapper = new Bootstrapper(launchMode)
            {
                MutexNamePrefix = "DTstrap-BackgroundUpdater",
            ...
            Task.Run(() =>
            {
                ...
                using (EventWaitHandle handle = new EventWaitHandle(false, EventResetMode.AutoReset, "DTstrap-BackgroundUpdaterKillEvent"))
                    handle.WaitOne();
