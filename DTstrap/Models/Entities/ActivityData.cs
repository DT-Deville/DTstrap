...
using DTstrap.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace DTstrap.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for dtstraprpc, discord rich presence, or game history
