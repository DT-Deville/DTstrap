...
using DTstrap.Integrations;

namespace DTstrap.UI.Elements.ContextMenu
{
    /// <summary>
    ...
    public partial class MenuContainer
    {
        ...
        private void Window_Loaded(object? sender, RoutedEventArgs e)
        {
            ...
            int exStyle = NativeInterop.GetWindowLong(hWnd, NativeInterop.GWL_EXSTYLE);
            exStyle |= NativeInterop.WS_EX_TOOLWINDOW;
            NativeInterop.SetWindowLong(hWnd, NativeInterop.GWL_EXSTYLE, exStyle);
        }
