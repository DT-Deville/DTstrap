...
using DTstrap.UI.Elements.Settings;
using DTstrap.UI.Elements.Editor;
using DTstrap.UI.Elements.Dialogs;
using System.Windows.Shell;

namespace DTstrap.UI.ViewModels.Settings
{
            ...
            set
            {
                if (String.IsNullOrEmpty(value))
                {
                    if (App.Settings.Prop.BootstrapperIcon == BootstrapperIcon.IconCustom)
                        App.Settings.Prop.BootstrapperIcon = BootstrapperIcon.IconDTstrap;
                }
                else
                {
