...
namespace DTstrap.UI.Utility
{
    public static class WindowScaling
    {
        public static double ScaleFactor => (Screen.PrimaryScreen?.Bounds.Width ?? SystemParameters.PrimaryScreenWidth) / SystemParameters.PrimaryScreenWidth;
