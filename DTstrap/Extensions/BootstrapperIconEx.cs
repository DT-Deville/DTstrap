...
namespace DTstrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconDTstrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconDTstrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconDTstrap => Properties.Resources.IconDTstrap,
                ...
                BootstrapperIcon.IconDTstrapClassic => Properties.Resources.IconDTstrapClassic,
                _ => Properties.Resources.IconDTstrap
            };
        }
    }
}
